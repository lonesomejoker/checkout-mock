...
const Home = () => {
  return (
    <div className='container font-poppins font-[500] text-[1rem] '>
      <div className=' flex'>
      <img src="https://marketplace.canva.com/EAFG6srv-fI/1/0/1131w/canva-white-and-red-clean-minimalist-fashion-magazine-cover-GYbcb8zmyTU.jpg" alt="desc" className=' h-[30rem] w-[19rem] lg:block hidden rounded-l-[2rem]'/>
